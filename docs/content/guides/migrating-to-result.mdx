...
sinceVersion: "@parity/product-sdk@0.18.0"
---

# Migrating to the `Result` API

> **Applies to `@parity/product-sdk` v0.18.0 and later.** If your app is already on
> v0.18.0+ and compiles, you're on the new API — this guide is only needed when
> upgrading from an earlier version (≤ v0.17.x).
