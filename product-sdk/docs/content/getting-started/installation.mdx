...
- **Runtime host** — `@parity/product-sdk` (the umbrella) requires a Nova Wallet host (Polkadot Desktop / Mobile) or the [`@parity/host-api-test-sdk`](https://github.com/paritytech/host-api-test-sdk) for local development. See [Runtime Environment](/getting-started/container-vs-standalone).
