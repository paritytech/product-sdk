...
Regenerate PAPI descriptors against current live-chain runtime metadata for `devnet-asset-hub`, `kusama-asset-hub`, `paseo-asset-hub`, `paseo-bulletin`, `paseo-individuality`, and `polkadot-asset-hub` (issue #242). `devnet-bulletin` was already at the live `codeHash` and is unchanged; `devnet-individuality` was unreachable at regeneration time and is left as-is.
